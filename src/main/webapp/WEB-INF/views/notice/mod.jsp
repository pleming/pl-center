...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/notice/mod.css">
    <script src="/resources/js/notice/mod.js"></script>
...
<div class="container-box">
    ...
    <div class="div-editor-footer">
        <button type="button" class="btn btn-success" onclick="modNotice()"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정완료</button>
